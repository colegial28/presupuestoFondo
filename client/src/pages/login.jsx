...
export default function Login() {
    const { handleLogin, handleFormData, hasError, msg } = useAuth()

    return (
        <Container className='auth'>
            <Form onSubmit={handleLogin} className='border rounded shadow-sm'>
                ...
                <Button type='submit' className='w-100' variant='dark'>Login</Button>
            </Form>
        </Container>
    )
}
